...
#		$t0: character being checked from 'str'
#		$t1: location in 'str' being checked 
#		$t2: store the number of 'char' in 'str'
#		$t3: stores 'char'
# 2. Currently, the program is stuck in an infinite loop. Make use of 
#    breakpoints to locate, and correct the error.
#		Error was the first line in 'con' "add $t1, $t2, 1" would not increment $t1 past 1 
#		changed to "add $t1, $t1, 1" to properly increment $t1
